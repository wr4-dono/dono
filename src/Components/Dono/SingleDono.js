  ...
  return (
    <div className='dono-container'>
      ...
      <div className='price-title'>
        ...
        <div className='price'><span className='pricetag'>Earn: ${donoInfo.price}</span></div>
        <div className='under-line'></div>
      </div>
      <div className='description'>{donoInfo.description}</div>

      <div className='zipcode'>zip code: {donoInfo.zip_code}</div>
      <div className='dono-needs'>
        <div>{donoInfo.multiple_people ? <div>Requires multiple people</div> : null}</div>
        <div>{donoInfo.truck_trailer ? <div> Requires a truck or trailer</div> : null}</div>
      </div>
